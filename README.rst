...
0.4.0     * add HTML summary report with per-sample selection/depletion
          ...
          * fix samtools filter flags for all four mode/layout combinations:
            selection+paired (-f2 -F256), selection+single (-F4),
            depletion+paired (-f12 -F256), depletion+single (-f4)
